...
const About = () => {
  return (
    <section id='about' className="p-4 md:p-9 bg-gray-100 shadow-xl">
      <div className="container mx-auto flex flex-col items-center">
        <img src={about} alt="About" className="w-full mb-4 px-6" /> {/* Replace 'about' with the path to the resized image */}
