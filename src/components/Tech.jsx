...
const Tech = () => {
  ...
  return (
    <section id='Tech' className="m-2 rounded-2xl bg-white shadow-xl">
      <div className="container mx-auto p-9">
        <h2 className="text-3xl font-bold text-center text-gray-800 p-2 m-2 rounded-xl shadow-md border border-gray-100 hover:shadow-xl transform hover:scale-105 transition duration-300 bg-gray-100">TECHNICAL <span className='text-red-600'>EVENTS</span></h2>      
